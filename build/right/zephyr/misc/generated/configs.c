...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MIN_INT, 12);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_NAME_MAX, 24);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_INPUT_SPLIT_MAX_TRACKED_KEYS, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_IDLE_SLEEP_TIMEOUT, 1800000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SHIELD_AROUND_FORTY_TB_RIGHT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZMK_BEHAVIOR_RGBLED_WIDGET_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZMK_BEHAVIOR_RGBLED_WIDGET, 1);
